...
setMethod("+", c("FLStock", "a4aFit"), function(e1, e2)
{
  ...
  landings.n(e1) <- (catch.n(e2)-discards.n(e1))/(2*catch.n(e2)-landings.n(e1)-discards.n(e1))
  discards.n(e1) <- (catch.n(e2)-landings.n(e1))/(2*catch.n(e2)-landings.n(e1)-discards.n(e1))
