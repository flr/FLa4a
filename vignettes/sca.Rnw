...
knit_theme$set(thm)
opts_chunk$set(dev='png', cache=FALSE, fig.align='center', warning=FALSE, message=FALSE, dev.args=list(type="cairo"), dpi=80, highlight=TRUE, background='#F2F2F2', fig.lp="fig:", fig.pos="H", width=70, tidy=TRUE)
@
...
\begin{equation*}
  \tilde{R}_y(a,b) = a_y S_{y-1} e^{-b_y S_{y-1}}
\end{equation*}
