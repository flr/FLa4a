...
<<F, fig.cap="3D contour plot of estimated fishing mortality at age and year", echo=FALSE>>=
...
wireframe(data~year+age, data=harvest(fit), zlab="F", ylab="Year", xlab="Age")
@
...
#          xlab="Age")
wireframe(data~year+age, data=stock.n(fit), zlab="N", ylab="Year", xlab="Age")
@
...
wireframe(data~year+age, data=catch.n(fit), zlab="C", ylab="Year", xlab="Age")
@
...
wireframe(data ~ age + year, data = as.data.frame(harvest(fit)), screen = list(x = -90, y=-45), zlab="F")
@
...
wireframe(data ~ age + year, data = as.data.frame(harvest(fit3)),  screen = list(x = -90, y=-45), zlab="F")
@
...
wireframe(data ~ age + year, data = as.data.frame(harvest(fit4)),  screen = list(x = -90, y=-45), zlab="F")
@
...
wireframe(data ~ age + year, data = as.data.frame(qhat),  screen = list(x = -90, y=-45), zlab="q")
@
